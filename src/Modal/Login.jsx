...
const Login = ({ toggleModal, status, openEmailModal }) => {
          ...
          <Carousel
            ...
            theme={{
              indicators: {
                ...
                wrapper: "carousel-indicator-wrapper",
              },
              scrollContainer: {
              ...
              control: {
                base: "inline-flex items-center justify-center bg-transparent flowbite-control",
                icon: "w-8 text-black dark:text-black bg-transparent",
              },
            }}
            onClick={(event) => {
        ...
        >
          <div className="p-6 pt-0">
            ...
            <div className="pt-5 flex flex-col items-center justify-center">
              ...
              <p
                className="font-bold text-sm pt-3 underline underline-offset-4"
                onClick={() => {
                  toggleModal();
                  openEmailModal();
                }}
